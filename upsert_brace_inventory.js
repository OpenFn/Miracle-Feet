fn(state => {
  //TODO: Check for discardedClinics... stop job if they exist
...
//TODO: Run NONE of these following steps if clinic_code in list of ^discardedClinics
...
upsertIf(
  ...
  fields(
    ...
    field('Brace_Type__c', state => {
      const ref =
        state.data.form.brace.brace_type ||
