fn(state => {
  ...
  return query(
    ...
    SMS_Treatment_Start_Date__c, Next_Visit_Date__c, Registration_Date__c, Date_of_First_Visit__c, Last_Visit_Date__c,
    SMS_Opt_In_II__c, SMS_Opt_In__c, 
    SMS_Treatment__c, SMS_Original_Treatment__c, Brace_Problems_Type__c
      FROM Contact 
      WHERE Send_SMS__c = true`
  )(state).then(state => {
