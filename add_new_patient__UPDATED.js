...
alterState(state => {
  ...
  if (state.discardedClinics.includes(clinic_code) || state.discardedCountries.includes(dataValue('state.data.form.calcs.locations.country')(state)) || test_clinic==='Yes' || test_user==='Yes') {  
    console.log(
