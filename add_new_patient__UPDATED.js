...
upsert("Contact", "CommCare_Case_ID__c", fields(
  ...
  field('Age_Months_First_Brace__c', dataValue('form.case.update.age_months_first_brace_rounded')),
  ...
  field('Location_Level_1_Other__c', dataValue('form.case.update.location_level1_other')),
  ...
  field('Other_Abnormalities__c', dataValue('form.case.update.abnormalities_other')),
  field('Consent_Treatment__c', dataValue('form.case.update.consent_treatment')),
  field('Consent_Database__c', dataValue('form.case.update.consent_included')),
  field('Consent_Photograph_Marketing__c', dataValue('form.case.update.consent_photograph_marketing')),
  field('Consent_Photograph_Treatment__c', dataValue('form.case.update.consent_photograph_treatment')),
  ...
  field('Guardian_1_First_Name__c', dataValue('form.case.update.guardian1_first_name')),
  field('Guardian_1_Last_Name__c', dataValue('form.case.update.guardian1_last_name')),
  field('Guardian_1_Relationship__c', dataValue('form.case.update.guardian1_relationship')),
  field('Guardian_1_Relationship_Other__c', dataValue('form.case.update.guardian1_relationship_other')),
  field('Guardian_1_Phone_Number_1__c', dataValue('form.case.update.guardian1_phone1')),
  field('Guardian_1_Phone_Number_2__c', dataValue('form.case.update.guardian1_phone2')),
  field('Guardian_2_First_Name__c', dataValue('form.case.update.guardian2_first_name')),
  field('Guardian_2_Last_Name__c', dataValue('form.case.update.guardian2_last_name')),
  field('Guardian_2_Relationship__c', dataValue('form.case.update.guardian2_relationship')),
  field('Guardian_2_Other_Relationship__c', dataValue('form.case.update.guardian2_relationship_other')),
  field('Guardian_2_Phone_Number_1__c', dataValue('form.case.update.guardian2_phone1')),
  field('Guardian_2_Phone_Number_2__c', dataValue('form.case.update.guardian2_phone2')),
  field('Guardian_3_First_Name__c', dataValue('form.case.update.guardian3_first_name')),
  field('Guardian_3_Last_Name__c', dataValue('form.case.update.guardian3_last_name')),
  field('Guardian_3_Relationship__c', dataValue('form.case.update.guardian3_relationship')),
  field('Guardian_3_Relationship_Other__c', dataValue('form.case.update.guardian3_relationship_other')),
  field('Guardian_3_Phone_Number_1__c', dataValue('form.case.update.guardian3_phone1')),
  field('Guardian_3_Phone_Number_2__c', dataValue('form.case.update.guardian3_phone2')),
  field('Tenotomy_Given__c', dataValue('form.case.update.tenotomy_given')),
  field('Tenotomy_Hospital__c', dataValue('form.case.update.tenotomy_hospital')),
  ...
  field('R_First_Brace_Pirani_Score__c', dataValue('form.case.update.r_first_brace_pirani_score')),
  field('L_First_Brace_Pirani_Score__c', dataValue('form.case.update.l_first_brace_pirani_score')),
  field('L_First_Pirani_Score__c', dataValue('form.case.update.l_first_pirani_score')),
  field('R_First_Pirani_Score__c', dataValue('form.case.update.r_first_pirani_score')),
  field('L_Most_Recent_Pirani_Score__c', dataValue('form.case.update.l_total_score')),
  field('R_Most_Recent_Pirani_Score__c', dataValue('form.case.update.r_total_score')),
  field('R_Pirani_Score_at_Tenotomy__c', dataValue('form.case.update.r_tenotomay_pirani_score')),
  field('L_Pirani_Score_at_Tenotomy__c', dataValue('form.case.update.l_tenotomay_pirani_score'))
));
